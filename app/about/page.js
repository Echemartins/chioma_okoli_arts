    ...
    <div className="bg-white text-gray-900 min-h-screen flex flex-col">
      ...
      <footer className="bg-white border-t border-orange-200 text-orange-900 mt-24">
        <div className="max-w-6xl mx-auto px-4 py-12 grid grid-cols-1 md:grid-cols-2 gap-10 text-center md:text-left">
          ...
          <div>
            ...
            <p className="text-sm mt-2">
              Email:{" "}
              <a
                href="mailto:Favourchomzy69@gmail.com"
                className="hover:underline text-orange-500"
              >
                Favourchomzy69@gmail.com
              </a>
            </p>
            <p className="text-sm mt-1">
              Phone:{" "}
              <a
                href="tel:+2347089277261"
                className="hover:underline text-orange-500"
              >
                +2347089277261
              </a>
          ...
          <div>
            ...
            <div className="flex justify-center md:justify-start items-center gap-4 text-2xl text-orange-600">
              <a
                href="https://instagram.com/chomzyart_"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.linkedin.com/in/chioma-favour-7631791a2?trk=contact-info"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-orange-800 transition"
              >
        ...
        <div className="bg-orange-100 text-center text-sm text-orange-800 py-4">
          &copy; {new Date().getFullYear()} Chioma-Okoli Arts. All rights
          reserved.
        </div>
      </footer>
    </div>
